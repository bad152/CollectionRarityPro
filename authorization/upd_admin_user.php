...
<h3 align="center">Изменение данных для пользователя  <?php print_r($user_id) ?></h3>
<br><br>
        <form action="update_admin_user.php?id=<?php echo $user_upd['id'] ?>" method="post" enctype="multipart/form-data">
          ...
          <div class="col-md-6 offset-md-3">
                ...
                <div class="col-md-6 offset-md-3">
                 ...
                 <div class="col-md-6 offset-md-3">
                    <div class="form-floating mb-3">
                        <input type="text" name="role" class="form-control" id="role" value="<?php echo $user_upd['role'] ?>" pattern="[1-2]{1}" required>
